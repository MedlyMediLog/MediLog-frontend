...
export default function ProductListingTopBar() {
  const [open, setOpen] = useState(false)
  return (
    <div className="fixed z-40 w-full flex h-[56px] p-[16px]  bg-gray-100 gap-30 desktop:py-4 desktop:px-5 desktop:h-auto">
