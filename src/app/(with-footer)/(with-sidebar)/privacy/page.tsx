      ...
      <div className="w-full mx-auto flex min-w-[630px] max-w-[900px] pt-[30px] px-[20px] pb-[60px] flex-col items-center gap-[30px]">
        ...
        <div className="flex flex-col items-start gap-1 w-full">
          ...
          <div className="flex flex-col typo-b2 text-fg-basic-primary">
            <div>
              <strong className="font-semibold">'딱!(TTAK!)'</strong>(이하 '서비스')는 회원가입 없이
              게스트 이용이 가능한 정보 제공 서비스를 기본으로 하며, 서비스 제공에 필수적인 경우를
              제외하고 개인정보를 수집하지 않습니다. 다만, 서비스 이용 과정에서 다음과 같은 정보가
              자동으로 생성·수집될 수 있습니다.
            </div>
